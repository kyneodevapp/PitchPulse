            ...
            <div className="container mx-auto px-4">
                <div className="mb-16">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div>
                            <h1 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tighter uppercase">Upcoming <span className="text-purple-500">Predictions</span></h1>
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-2xl px-6 py-4 backdrop-blur-xl">
                            <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.3em] block mb-1">Coverage</span>
